...
Execute unit tests
```
    cd "AWSServerless_Google_Geocoding_Api/test/AWSServerless_Google_Geocoding_Api.Tests"
    dotnet test
```

Deploy application
```
    cd "AWSServerless_Google_Geocoding_Api/src/AWSServerless_Google_Geocoding_Api"
